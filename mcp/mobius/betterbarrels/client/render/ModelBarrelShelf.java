...
public class ModelBarrelShelf extends ModelBase {
	...
	public ModelBarrelShelf(){
	    ...
	    shape3 = new ModelRenderer(this, 0, 0);
	    shape3.addBox(0F, 0F, 0F, 15, 16, 1);
	    ...
	    shape4 = new ModelRenderer(this, 0, 0);
	    shape4.addBox(0F, 0F, 0F, 15, 1, 14);
	    ...
	    shape5 = new ModelRenderer(this, 0, 0);
	    shape5.addBox(0F, 0F, 0F, 15, 1, 14);
	    ...
	    shape6 = new ModelRenderer(this, 0, 0);
	    shape6.addBox(0F, 0F, 0F, 15, 1, 14);
	    shape6.setRotationPoint(-8F, 15.5F, -7F);
	    shape6.setTextureSize(64, 32);
	    shape6.mirror = true;
	    setRotation(shape6, 0F, 0F, 0F);
		  
	    shape7 = new ModelRenderer(this, 0, 0);
	    shape7.addBox(0F, 0F, 0F, 15, 1, 14);
	    shape7.setRotationPoint(-8F, 23F, -0.5F);
	    shape7.setTextureSize(64, 32);
	    shape7.mirror = true;
	    setRotation(shape7, 1.570796F, 0F, 0F);
	}
...
/*
public class ModelBarrelShelve extends ModelBase {

	public ModelBarrelShelve(){	
	}
